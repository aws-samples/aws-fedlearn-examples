...
def lambda_handler(event, context):
    ...
    receivedNodes, roundId, token = receiveUpdatedModelsFromClients(transactions, task_name)
    ...
    if (receivedNodes != None):
        # aggregation updates
        avg_TrainAcc, avg_TestAcc, avg_TrainLoss, avg_TestLoss, global_model_name = fedAvg(receivedNodes, roundId)
